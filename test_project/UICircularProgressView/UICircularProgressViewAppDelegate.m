...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
	    self.viewController = [[UICircularProgressViewViewController alloc] initWithNibName:@"UICircularProgressViewViewController_iPhone" bundle:nil];
	} else {
	    self.viewController = [[UICircularProgressViewViewController alloc] initWithNibName:@"UICircularProgressViewViewController_iPad" bundle:nil];
	}
